...
public:
    Motree(int layer = 6, int level = 4, int valDom = 1000000) : mLevel(layer), level(level), valDom(valDom), pubcells(10+1), subcells(level*(level+1)/2), subdata((int)(pow(subcells, layer-2)*10*10 + 0.5)), pubdata((int)(pow(pubcells, layer) + 0.5))
    {
